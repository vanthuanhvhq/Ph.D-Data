...
void setup()
{
  ...
  FuzzySet *VC = new FuzzySet(0, 0, 0, 1);            // Instantiating a FuzzySet object
  distance->addFuzzySet(VC);                          // Including the FuzzySet into FuzzyInput
  FuzzySet *NC = new FuzzySet(0, 1, 1, 2);            // Instantiating a FuzzySet object
  distance->addFuzzySet(NC);                          // Including the FuzzySet into FuzzyInput
  FuzzySet *C = new FuzzySet(1, 2, 2, 3);             // Instantiating a FuzzySet object
  distance->addFuzzySet(C);                           // Including the FuzzySet into FuzzyInput
  FuzzySet *M = new FuzzySet(2, 3, 3, 5);             // Instantiating a FuzzySet object
  distance->addFuzzySet(M);                           // Including the FuzzySet into FuzzyInput
  FuzzySet *NF = new FuzzySet(3, 5, 5, 7);            // Instantiating a FuzzySet object
  distance->addFuzzySet(NF);                          // Including the FuzzySet into FuzzyInput
  FuzzySet *F = new FuzzySet(5, 7, 7, 10);            // Instantiating a FuzzySet object
  distance->addFuzzySet(F);                           // Including the FuzzySet into FuzzyInput
  FuzzySet *VF = new FuzzySet(7, 10, 10, 10);         // Instantiating a FuzzySet object
  ...
  FuzzySet *VBN = new FuzzySet(-PI, -PI, -PI, -PI / 2);     // Instantiating a FuzzySet object
  deltaTheta->addFuzzySet(VBN);                             // Including the FuzzySet into FuzzyInput
  FuzzySet *BN = new FuzzySet(-PI, -PI / 2, -PI / 2, -PI / 4); // Instantiating a FuzzySet object
  deltaTheta->addFuzzySet(BN);                              // Including the FuzzySet into FuzzyInput
  FuzzySet *N = new FuzzySet(-PI / 2, -PI / 4, -PI / 4, 0); // Instantiating a FuzzySet object
  deltaTheta->addFuzzySet(N);                               // Including the FuzzySet into FuzzyInput
  FuzzySet *Z = new FuzzySet(-PI / 4, 0, 0, PI / 4);        // Instantiating a FuzzySet object
  deltaTheta->addFuzzySet(Z);                               // Including the FuzzySet into FuzzyInput
  FuzzySet *P = new FuzzySet(0, PI / 4, PI / 4, PI / 2);    // Instantiating a FuzzySet object
  deltaTheta->addFuzzySet(P);                               // Including the FuzzySet into FuzzyInput
  FuzzySet *BP = new FuzzySet(PI / 4, PI / 2, PI / 2, PI);  // Instantiating a FuzzySet object
  deltaTheta->addFuzzySet(BP);                              // Including the FuzzySet into FuzzyInput
  FuzzySet *VBP = new FuzzySet(PI / 2, PI, PI, PI);         // Instantiating a FuzzySet object
  ...
  FuzzySet *VSR = new FuzzySet(0, 0, 0, 5);        // Instantiating a FuzzySet object
  omegaR->addFuzzySet(VSR);                        // Including the FuzzySet into FuzzyOutput
  FuzzySet *SR = new FuzzySet(0, 5, 5, 10);        // Instantiating a FuzzySet object
  omegaR->addFuzzySet(SR);                         // Including the FuzzySet into FuzzyOutput
  FuzzySet *NMBR = new FuzzySet(5, 10, 10, 15);    // Instantiating a FuzzySet object
  omegaR->addFuzzySet(NMBR);                       // Including the FuzzySet into FuzzyOutput
  FuzzySet *MBR = new FuzzySet(10, 15, 15, 20);    // Instantiating a FuzzySet object
  omegaR->addFuzzySet(MBR);                        // Including the FuzzySet into FuzzyOutput
  FuzzySet *NBR = new FuzzySet(15, 20, 20, 25);    // Instantiating a FuzzySet object
  omegaR->addFuzzySet(NBR);                        // Including the FuzzySet into FuzzyOutput
  FuzzySet *BR = new FuzzySet(20, 25, 25, 30);     // Instantiating a FuzzySet object
  omegaR->addFuzzySet(BR);                         // Including the FuzzySet into FuzzyOutput
  FuzzySet *VBR = new FuzzySet(25, 30, 30, 30);    // Instantiating a FuzzySet object
  ...
  FuzzySet *VSL = new FuzzySet(0, 0, 0, 5);        // Instantiating a FuzzySet object
  omegaL->addFuzzySet(VSL);                        // Including the FuzzySet into FuzzyOutput
  FuzzySet *SL = new FuzzySet(0, 5, 5, 10);        // Instantiating a FuzzySet object
  omegaL->addFuzzySet(SL);                         // Including the FuzzySet into FuzzyOutput
  FuzzySet *NMBL = new FuzzySet(5, 10, 10, 15);    // Instantiating a FuzzySet object
  omegaL->addFuzzySet(NMBL);                       // Including the FuzzySet into FuzzyOutput
  FuzzySet *MBL = new FuzzySet(10, 15, 15, 20);    // Instantiating a FuzzySet object
  omegaL->addFuzzySet(MBL);                        // Including the FuzzySet into FuzzyOutput
  FuzzySet *NBL = new FuzzySet(15, 20, 20, 25);    // Instantiating a FuzzySet object
  omegaL->addFuzzySet(NBL);                        // Including the FuzzySet into FuzzyOutput
  FuzzySet *BL = new FuzzySet(20, 25, 25, 30);     // Instantiating a FuzzySet object
  omegaL->addFuzzySet(BL);                         // Including the FuzzySet into FuzzyOutput
  FuzzySet *VBL = new FuzzySet(25, 30, 30, 30);    // Instantiating a FuzzySet object
